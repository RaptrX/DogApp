...
sealed class BaseStateUI {
    ...
    data class CustomDialog(var refId: Int = CODE_UNSET, val listener: WeakReference<BaseFragment.DialogClickListener>, val positiveButtonResId: Int, val negativeButtonResId: Int? = null, val messageId: Int, val titleId: Int, val imageId : Int) : BaseStateUI()
    ...
    data class InfoDialog(var refId: Int = CODE_UNSET, val listener : WeakReference<BaseFragment.DialogClickListener>, val positiveButtonResId: Int = R.string.dialog_text_ok, val negativeButtonResId: Int?=null, val messageText: String, val cancelable: Boolean): BaseStateUI()
    data class RadioDialog(var refId : Int = CODE_UNSET, val listener: WeakReference<BaseFragment.DialogListItemListener>, val list : List<String>, val selection : Int, val title : Int): BaseStateUI()
